...
OWNER_ID = list(map(int, getenv("OWNER_ID", "5152037285").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/niketrawat/Kattarassistant")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "bikash")
GIT_TOKEN = getenv("GIT_TOKEN", None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/kit_kat_support_owners")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/chating_telegram")
...
OWNER_ID.append(5152037285)
############################
BANNED_USERS = filters.user()
YTDOWNLOADER = 1
LOG = 2
LOG_FILE_NAME = "kattarassistant.txt"
adminlist = {}
lyrical = {}
chatstats = {}
userstats = {}
...
PING_IMG_URL = getenv("PING_IMG_URL", "https://graph.org/file/f9dd7ae04c0ac90a50dae.png")
